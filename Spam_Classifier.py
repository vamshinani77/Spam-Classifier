...
print('I cant pick the phone right now. Pls send a message', sc_tf_idf.classify(pm))

pm = process_message('Congratulations ur awarded $500 ')
print('Congratulations ur awarded $500 ' ,sc_tf_idf.classify(pm))
